...
def run_inference(inference_script_path):
    ...
    # To avoid modifying the script too much, we'll run it from the base dir where inputs_prediction exists.
...
def get_coords(tmp_id, idx):
    ...
    cif_dir = os.path.join(OUTPUTS_DIR, "boltz_results_inputs_prediction", "predictions", tmp_id)
